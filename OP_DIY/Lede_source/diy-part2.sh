...
# 提醒：每次修改文件后，起码要间隔3~5分钟再执行命令，修改才生效
...
uci set network.lan.proto='dhcpv6'                                          #开启ipv6
uci set network.lan.ifname='@lan'                                           #开启ipv6
uci set network.lan.reqaddress='try'                                        #开启ipv6
uci set network.lan.reqprefix='auto'                                        #开启ipv6
